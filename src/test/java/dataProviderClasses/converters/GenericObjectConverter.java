package dataProviderClasses.converters;
 ...
 * Integer i = GenericObjectConverter.convert(o1, Integer.class);
 * System.out.println(i); // 1
 *
 * Object o2 = "false";
 * Boolean b = GenericObjectConverter.convert(o2, Boolean.class);
 * System.out.println(b); // false
 *
 * Object o3 = new Integer(123);
 * String s = GenericObjectConverter.convert(o3, String.class);
 * System.out.println(s); // 123
 * </pre>
 *
 * Not all possible conversions are implemented. You can extend the <tt>GenericObjectConverter</tt>
 ...
 */
public final class GenericObjectConverter {
    ...
    static {
        // Preload converters.
        Method[] methods = GenericObjectConverter.class.getDeclaredMethods();
    ...
    private GenericObjectConverter() {
